...
##################################################
INPUT=srl.test.korean.conll
Lang="eng" # This string does not affect the train result
MODEL="srl-korean.model"
OUTPUT="srl-korean.out"
...
CP="srl.jar:pathlstm.jar:lib/liblinear-1.51-with-deps.jar:lib/anna-3.3.jar"
